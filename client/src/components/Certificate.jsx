...
export const Certificate = ({ certificateData, onClose }) => {
  return (
    <div className="relative w-[1000px] h-[600px] bg-gradient-to-br from-white to-[#FFEADC] rounded-[20px]">
      <button
        onClick={onClose}
        className="absolute left-[30px] top-[20px] w-[42px] h-[42px] rounded-full bg-[#D9D9D960] backdrop-blur-[70px] flex items-center justify-center" // Add flex, items-center, justify-center
      >
